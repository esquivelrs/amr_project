...
# from amr_prj.cfg import PositionControlConfig
...
class PositionControllerNode:
    def __init__(self):
        ...
        # ROS infrastructure
        self.sub_cmd_pose = rospy.Subscriber('/bluerov2/pose_gt', numpy_msg(geometry_msgs.PoseStamped), self.cmd_pose_callback)
        self.sub_cmd_pose_iio = rospy.Subscriber('/iio/pose_gt', numpy_msg(geometry_msgs.PoseStamped), self.control_callback)
        ...
        self.config_callback(None, None)
    ...
    def control_callback(self, msg):
        ...
        print('#########control_callback: msg.header.stamp = ', msg.header.stamp)
        p = msg.pose.pose.position
        q = msg.pose.pose.orientation
        p = numpy.array([p.x-2.0, p.y, p.z])
    ...
    def config_callback(self, config, level):
        ...
        self.pid_pos = PIDRegulator(1.0, 0.0, 0.0, 10.0)
        self.pid_rot = PIDRegulator(1.0, 0.0, 0.0, 3.0)
